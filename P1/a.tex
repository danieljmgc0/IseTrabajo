...
\section{Contexto}
Para el experimento se supone realizada previamente una actividad que consiste en la evaluacón de la interfaz gráfica por parte de un equipo desarrollador sobre unos usuarios usando los dos métodos de evaluación \textbf{A/B Testing} y \textbf{Recorrido Pluralista}. Entonces, nuestro estudio se centrará en recopilar información de cómo ha sido la experiencia de estos desarrolladores usando las dos técnicas de evaluación.
