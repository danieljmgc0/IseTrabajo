...
El experimento combina dos enfoques metodológicos: un diseño \textit{between-subjects} para los usuarios de la primera fase (cada usuario solo prueba una versión) y un diseño \textit{within-subjects} para los desarrolladores, que utilizan ambos métodos. 
...
El experimento realizado tiene relevancia tanto a nivel académico como profesional dentro del ámbito del desarrollo de software. Desde el punto de vista científico, los resultados pueden ayudar a comprender mejor las diferencias entre el A/B Testing y el Recorrido Pluralista, dos métodos muy utilizados para evaluar la usabilidad. Esta comparación puede servir de base para futuras investigaciones sobre su efectividad, el esfuerzo que requieren y en qué tipos de proyectos o fases de diseño encaja mejor cada uno.

A nivel profesional, los hallazgos pueden orientar a los equipos de desarrollo a la hora de elegir el método más adecuado según los objetivos y recursos disponibles. Si el A/B Testing resulta más eficiente en determinados contextos, podría recomendarse para validaciones rápidas basadas en datos. Por otro lado, el Recorrido Pluralista, al fomentar el análisis conjunto entre distintos perfiles, puede resultar más útil en fases tempranas de diseño o cuando se busca obtener una visión cualitativa más completa. En ambos casos, aplicar de forma sistemática evaluaciones de usabilidad favorece una cultura de diseño centrada en el usuario, reduce errores, mejora la experiencia final y evita costes derivados de tener que rediseñar interfaces más adelante.

Más allá del ámbito del software, la elección de un método de evaluación también conlleva otras implicaciones de carácter social, económico, jurídico e incluso medioambiental.
Desde una perspectiva social, una mejor usabilidad facilita el acceso a la tecnología y favorece la inclusión de personas con menos experiencia digital o con discapacidad.

En cuanto al aspecto económico, identificar problemas de usabilidad de forma temprana suele suponer un ahorro considerable. Corregir fallos una vez que el producto está en funcionamiento es costoso, y una buena usabilidad nos ahorraría ya no sólo tiempo sino reducción de incidencias, lo que nos daría mejores resultados.

También existen implicaciones jurídicas, sobre todo relacionadas con la accesibilidad y el tratamiento de datos. Como por ejemplo en Europa con la normativa RGPD o las leyes de accesibilidad digital, que influyen directamente en cómo se debe llevar a cabo una evaluación con usuarios.

Por último, aunque el impacto ambiental no es muy elevado si que afecta el que para realizar las evaluaciones se requiera una mínima infraestrucutra(servidores, almacenamiento...)lo que provocaría un consumo energético. En cualquier caso, el mejorar la usabilidad, por ejemplo, contribuiría a que los usuarios hagan sus tareas más rápido reduciendo así el uso de dispositivos y energía, lo que tendría un pequeño beneficio ambiental.
